Rails.application.routes.draw do
  ...
  post '/cart_items/checkout', to: 'cart_items#checkout', as: 'checkout_cart_items'
  ...
  resources :orders, only: [:index, :show, :new, :create, :edit, :update, :destroy, :new_search] do
    collection do
      get 'search', action: :new_search
    end
  end
