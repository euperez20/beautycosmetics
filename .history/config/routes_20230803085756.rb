...
# Ruta para calcular los impuestos y proceder al checkout
post '/cart/calculate_taxes', to: 'cart_items#calculate_taxes_and_proceed_to_checkout', as: :calculate_taxes_and_proceed_to_checkout_cart_items
