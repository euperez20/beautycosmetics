class CartItemsController < ApplicationController
  ...
  def checkout
    ...
    # Initialize @checkout_data with an empty hash
    @checkout_data = {}
  
    # Check if the form was submitted for calculating taxes
    if params[:calculate_taxes].present?
      ...
      @checkout_data[:total_amount_with_taxes] = @subtotal + taxes[:total_amount_with_taxes]
    end
  end
