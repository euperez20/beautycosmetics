class CartItemsController < ApplicationController
  ...
  def calculate_taxes
    ...
    # @total_amount_with_taxes = @subtotal + total_taxes
      ...
      total_gst = (@subtotal * province.gst_rate).round(2)
  total_pst = (@subtotal * province.pst_rate).round(2)
  total_hst = (@subtotal * province.hst_rate).round(2)
  total_taxes = (total_gst + total_pst + total_hst).round(2)
  @total_amount_with_taxes = (@subtotal + total_taxes).round(2)
