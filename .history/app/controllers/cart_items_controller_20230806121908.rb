class CartItemsController < ApplicationController
  ...
  def checkout
    ...
    if session[:user_name].blank? || session[:user_address].blank? || province.blank?
    ...
    # Store the province name in the session for later use
    session[:province_name] = province.name

    # Redirect to the show view (checkout) to display the details
