class CategoriesController < ApplicationController
  ...
  def search
    ...
    if @category.present? && search_term.present?
      ...
      # Redirigir a la vista que muestra los productos de la categoría seleccionada
      ...
      # Redirigir a la vista que muestra los resultados de búsqueda
      render 'search_results'
    else
      @products = Product.all
      # Redirigir a la vista que muestra todos los productos
      render 'all_products'
    end
  end
  ...
  def show_products
    ...
    search_term = params[:search]
    if search_term.present? && @category.present?
