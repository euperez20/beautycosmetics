class Province < ApplicationRecord
  ...
  # Ensure hst_rate is numeric and greater than or equal to 0
  validates :hst_rate, numericality: { greater_than_or_equal_to: 0 }

  # Custom validation method to check if hst_rate is applicable
  validate :hst_applicable_validation
