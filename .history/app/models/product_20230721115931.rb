class Product < ApplicationRecord
  ...
  def valid_image_url
    ...
    # Aquí puedes agregar validaciones adicionales para el enlace URL,
    # como verificar el formato o la existencia de la imagen en el enlace.

    unless image_url.start_with?('http', 'https')
      errors.add(:image_url, 'must start with "http" or "https"')
    end
  end
