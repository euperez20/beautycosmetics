...
class ColorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create color" do
    assert_difference("Color.count") do
      post colors_url, params: { color: { color_name: @color.color_name, hex_value: @color.hex_value } }
    end
  ...
  test "should update color" do
    patch color_url(@color), params: { color: { color_name: @color.color_name, hex_value: @color.hex_value } }
